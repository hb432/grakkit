    ...
    public void open() {
        ...
        nodeThread = new Thread(() -> {
            ...
            try {
                ...
                nodeRuntime.getGlobalObject().set("Grakkit", new KontextAPI(this));
...
//    @Override
//    public void close() {
//        System.out.println("NodeInterop close() called.");
//        if (linkage != null) {
//            try {
//                System.out.println("Disposing JavaScript objects in V8...");
//                linkage.nodeRuntime.getExecutor("java = undefined;").executeVoid();
//            } catch (JavetException e) {
//                System.err.println("Error disposing JavaScript objects: " + e.getMessage());
//            }
//
//            System.out.println("Unregistering JVM interceptor...");
//            if (linkage.javetJVMInterceptor != null) {
//                try {
//                    linkage.javetJVMInterceptor.unregister();
//                    System.out.println("JVM interceptor unregistered.");
//                } catch (JavetException e) {
//                    System.err.println("Error unregistering JVM interceptor: " + e.getMessage());
//                }
//            }
//
//            System.out.println("Clearing V8 value objects from factory...");
//            try {
//                JavetReflectionObjectFactory.getInstance().clear();
//            } catch (Exception e) {
//                System.err.println("Error clearing V8 value objects: " + e.getMessage());
//            }
//
...
//        }
//
//        System.out.println("Interrupting NodeJS thread...");
//        if (nodeThread != null && nodeThread.isAlive()) {
//            nodeThread.interrupt();
//            try {
//                nodeThread.join(1000); // Wait for the thread to terminate (with a timeout)
//                if (nodeThread.isAlive()) {
//                    System.err.println("NodeJS thread did not terminate within the timeout.");
//                } else {
//                    System.out.println("NodeJS thread terminated.");
//                }
//            } catch (InterruptedException e) {
//                Thread.currentThread().interrupt();
//            }
//        }
//
//        // Close the Javet engine pool
//        System.out.println("Closing Javet engine pool...");
//        try {
//            javetEnginePool.close();
//            System.out.println("Javet engine pool closed.");
//        } catch (JavetException e) {
//            throw new RuntimeException(e);
//        }
//
//        super.close();
//        System.out.println("NodeInterop closed.");
//    }
    @Override
    public void close () {
...
//                linkage.nodeRuntime.setPurgeEventLoopBeforeClose(true);
    ...
    public void execute() throws Throwable {
        ...
        File index = Paths.get(this.root).resolve(Grakkit.config.main).toFile();
        if (index.exists()) {
            try {
                runJS(() -> {
                    try {
                ...
                throw new RuntimeException("Failed to execute main script: " + Grakkit.config.main, e);
            }
        } else {
            ...
            try {
                ...
                throw new RuntimeException("Failed to execute main script after creation: " + Grakkit.config.main, e);
            }
        }
    }
